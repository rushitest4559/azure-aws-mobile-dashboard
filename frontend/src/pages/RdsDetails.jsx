...
const YesNoBadge = ({ value }) => (
    <div className={`px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${value ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600'}`}>
        {value ? 'Yes ✓' : 'No —'}
    </div>
);
                ...
                <div className="mb-6 sm:mb-8">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 truncate" title={rawId}>
                                {rawId}
                            </h1>
